...
<%@page import="com.dis.modul.CustomerRequest"%>
<%@page import="com.dis.modul.ShopPojo"%><!DOCTYPE HTML>
<html>
	<head>
		<title>Gretong</title>
									...
									<div id="tabs" class="tabs">
										...
										<table id="customers">
											<%
												...
												List<ShopPojo> list = userDao.getRequest((String) httpSession
														.getAttribute("did"));
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<button>
																<a
																	href="DisActions?type=Accepted&pid=<%=disPojo.getProductId()%>">Approve</a>
															</button>
															&nbsp;
															<button>
																<a
																	href="ManActions?type=decline&pid=<%=disPojo.getProductId()%>">Decline</a>
															</button>
														</td>
														<%
															} else {
...
new CBPFWTabs(document.getElementById('tabs'));
											...
											<div class="sidebar-menu">
												<header class="logo1">
												<a href="#" class="sidebar-icon"> <span
