...
<%@page import="com.dis.modul.ManPojo"%>
												...
												<form action="DistributorRequest" method="post">
													<label>
														...
														<select style="width: 150px; height: 30px"
															onchange="callBfg(this)" name="man">
													</label>
													<option>
														Choose Here
													</option>
													...
													<label>
														Product Id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
														<select style="width: 150px; height: 30px" id="ppid"
															onchange="callFs()" name="pid">
													</label>
													</select>
													<br />
													<br />
													<label>
														Product Name :
														<select style="width: 150px; height: 30px" id="pname"
															onchange="callFasak()" name="pname">
													</label>
													<option></option>
													</select>
													<br />
													...
													<input type="submit" value="Request to Manufacturer" style="background-color: black;color: white;">
												</form>
											</div>
										</div>
									</div>
									...
									<table id="customers">
										...
										<tbody>
											<tr>
												...
												%>
												<td style="color:purple;"><img src="images/Spinner.gif" width="20%"><%=disPojo.getStatus().toUpperCase() %></img></td>
												<%
													} else if (disPojo.getStatus().equalsIgnoreCase("Declined")) {
												%>
												<td><%=disPojo.getStatus()%></td>
												<%
													} else if(disPojo.getDistributorPrice().equals("0")&disPojo.getStatus().equalsIgnoreCase("Approved")) {
												%>
												<td><p>PAY</p></td>
												<%}else{ %>
												<td>
													<button style="background:#15c79e">
														<a
															href="DistributorContract?id=<%=disPojo.getProductId()%>"
															style="color: white;">Track here</a>
													</button>
												</td>
												<%
													}
...
<%--										Fake Product--%>
<%--									</h3>--%>
<%--									<div class="registration_form" style="width: fit-content;"--%>
<%--										align="center">--%>
<%--										<!-- Form -->--%>
<%--										<form action="FackProduct" method="post"--%>
<%--											enctype="multipart/form-data">--%>
<%--											<div>--%>
<%--												<label>--%>
<%--													<input placeholder="Name" type="text" name="mName"--%>
<%--														tabindex="1" required="" autofocus="">--%>
<%--												</label>--%>
<%--											</div>--%>
<%--											<div>--%>
<%--												<label>--%>
<%--													<input placeholder="ProductId" type="text" tabindex="2"--%>
...
<%--														name="productName" tabindex="1" required="">--%>
<%--												</label>--%>
<%--											</div>--%>
<%--											<div>--%>
<%--												<label>--%>
...
<%--											<div>--%>
<%--												<label>--%>
<%--													<input placeholder="Price" type="file" name="file"--%>
<%--														tabindex="3" required="">--%>
<%--												</label>--%>
<%--											</div>--%>
<%--											<div>--%>
	...
	function show_content(index) {
						...
						<div class="col-md-6 s-c">
							...
							<li>
								<div class="social-ic">
									<ul>
										<li>
											<a href="#"><i class="facebok"> </i> </a>
										</li>
										<li>
											<a href="#"><i class="twiter"> </i> </a>
										</li>
										<li>
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					<li>
						<a href="dmenu.jsp"><i class="fa fa-tachometer"></i> <span>Home</span>
						</a>
					</li>

					<li id="menu-academico">
						<a href="dpros.jsp"><i class="fa fa-file-text-o"></i> <span>Distributor
								Products</span> </a>
					</li>
					<li>
						<a href="cus_requests.jsp"><i class="lnr lnr-pencil"></i> <span>CONSUMER
								REQUEST</span> </a>
					</li>
					<li id="menu-academico">
					...
					<li id="menu-academico">
						<a href="dshipment.jsp"><i class="lnr lnr-book"></i> <span>Shipment</span>
						</a>
					</li>
