...
<%@page import="com.Modul.ManifactureMakingProductPojo"%>
<!DOCTYPE HTML>
<html>
<head>
<title>Gretong</title>
...
<div class="women_main">
   ...
   <div class="w_content">
		...
		<div class="grids_of_4">
		  ...
		  Dao  dao=new  Dao();
		  List<ManifactureMakingProductPojo> list=dao.getMakingProduct(manifacturename);
		  for(ManifactureMakingProductPojo pojo:list){
			  System.out.print("------------><>"+pojo.getProductName());
		  %>
			<div class="grid1_of_4">
				<div class="content_box"><a href="details.html">
			   	   	 <img src="http://localhost:8888/<%=pojo.getImagepath().replace("webapps","")%>" style="height: 70px;width: 100px" class="img-responsive" alt="">
				   	  </a>
				    <h4><a href="details.html"> <%=pojo.getProductName() %></a></h4>
				     <p><%=pojo.getProductid() %></p>
					 <div class="grid_1 simpleCart_shelfItem">
				    
					 <div class="item_add"><span class="item_price"><h6><%=pojo.getPrice()%></h6></span></div>
					<div class="item_add"><span class="item_price"><a href="ReadContract?id=<%=pojo.getProductid()%>">TRACK</a></span></div>
					 </div>
			   	</div>
			</div>
			<%} %>
