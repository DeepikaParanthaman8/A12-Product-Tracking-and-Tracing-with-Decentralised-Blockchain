         ...
         <%} %>
			...
			<div class="login-body">
				<form action="SupplierRegister" method="post">
					...
					<input type="text" class="user" name="producttype" placeholder="Product Type" required="">
					<input type="text" class="user" name="email" placeholder="Enter your email" required="">
					<input type="text" class="user" name="mobile" placeholder="Enter your Mobile Number" required="">
