...
<%@page import="com.Modul.ManufactureInven"%><!DOCTYPE HTML>
<html>
<head>
...
<body>
									...
									<!--/tabs-inner-->
										<div class="tab-inner">
											<div id="tabs" class="tabs">
												<h2 class="inner-tittle" align="center">Assemble A Product</h2>
  ...
  Dao dao=new Dao();
  List<ManufactureInven> list=dao.getManifactureDetils(myName);
  
  for(ManufactureInven pojo:list){
	  System.out.print(pojo.getManufacturename());
	  if(pojo.getQuanity().equals("0")){
  %>
  <%}else{ %>
  <tr>
    ...
    <td><%=pojo.getQuanity() %></td>
    <td><input id="name" value="0" type="number" name ="sele"></input></td>
    <td><input type="checkbox" value="<%=pojo.getSupplierid()+"@"+pojo.getProductid()+"@"+pojo.getProductname()%>" name ="optio"></td>
  </tr>
  <% }}%>
</table><br/><center>
<input type="submit" value="Generate Product"  style="background-color:maroon;color: white;"/></center>
</form>												<!-- /tabs -->
											</div>
