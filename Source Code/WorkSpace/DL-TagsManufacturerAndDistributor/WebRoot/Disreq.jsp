...
<%@page import="com.dis.modul.DisPojo"%><!DOCTYPE HTML>
<html>
<head>
<title>Gretong</title>
									...
									<!--/tabs-inner-->
										<div class="tab-inner">
											<div id="tabs" class="tabs">
												<h2 class="inner-tittle" align="center">Distributor Requests </h2>
												<%
HttpSession session2=request.getSession(false);  
String n=(String)session.getAttribute("name");  
UserDao userDao=new UserDao();
List<DisPojo> list=userDao.loadDistributorRequestsId(n);
if(!list.isEmpty()){
%>
													<table id="customers">
 <tr>
...
%>	
 ...
 <tr>
	...
	<td><button style="background-color: aqua;color: white;"><a href="ManActions?type=approve&pid=<%=disPojo.getProductId() %>&date=<%=disPojo.getDateTime() %>">Approve</a></button>&nbsp;<button><a href="ManActions?type=decline&pid=<%=disPojo.getProductId() %>&date=<%=disPojo.getDateTime() %>">Decline</a></button></td>
	<%}else{ %>
...
<%}else{%>
<center><label>No Distributer Requests found</label></center>
<%} %>
