						...
						<div class="col-md-6">
							<div class="panel panel-widget">
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									<div class="input-info">
										<h3 align="center">Manifacture Product</h3>
									</div>
									<div class="form-body form-body-info">
										<form action="ManifactureProduct" method="post" enctype="multipart/form-data">
											<div class="form-group valid-form">
											<input type="hidden" name="detail" value="<%=details %>">
												<input type="text" name="proid" class="form-control"  placeholder="Product_Id" required="" onclick="randomValue();" id="tb" readonly="readonly">
											</div>
											<div class="form-group has-feedback">
												<input type="text" name="name" class="form-control" placeholder="Product_Name"  required="">
											</div>	
											<div class="form-group">
											  <input type="text" name="description"  class="form-control"  placeholder="Description" required="">
											</div>
											<div class="form-group">
											  <input type="text" name="numberofproduct"  class="form-control"  placeholder="How many Product" required="">
											</div>
											<div class="form-group">
											  <input type="text" name="price" class="form-control" placeholder="Price" required="">
											</div>
											<div class="form-group">
											  <input type="file" name="pic" placeholder="PHOTO" required="" accept="image/*">
											</div>
											<div class="form-group" align="center">
												<button type="submit" style="background-color:olive;color: white;">Submit</button>
											</div>
											</form>
											</div>
									</div>
