...
<html>
<head>
<title>Gretong a Ecommerce Admin </title>
...
<div class="women_main">
	...
	<div class="grids">
					<div class="progressbar-heading grids-heading">
						<h2 align="center">Getting BlockChain Details...!</h2><br/>
					</div>
...
function callF() {
	document.getElementById('hello').style.display = 'block';
						...
						<center>	<label onclick="callF()">
								<b>Click Hear.. <span style="color: red"><%=request.getAttribute("id") %></span>
									here...</b>
							</label></center>
							<div class="form" align="center">
								<div id="hello" style="width:max-content" align="left">
								<h4 align="center" style="background-color:slategray;color: white;">Manufacturing</h4><br/>
									...
									<p>
										...
										<%=model.getPrice() %></p>
										<b>Product Counts&nbsp;&nbsp;&nbsp;&nbsp;:</b>
										<%=model.getNumberOfProduct()%></p>
										
										<b>Assemble Date&nbsp;&nbsp;&nbsp;:</b>
										<%=model.getAssembleDate()%></p>
                                       ...
                                       <h4 align="center" style="background-color:slategray;color: white;">Suppliers</h4><br/>
