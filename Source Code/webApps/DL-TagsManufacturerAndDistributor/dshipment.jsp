   ...
   <div class="w_content">
	...
	<%String info = (String)request.getAttribute("status") !=null ? (String) request.getAttribute("status"):"" ; 
			...
			<div class="w3l_banner_nav_right">
				<h2 align="center" style="color:purple;">ADD SHIPMENT</h2><br/><br/>
				<div class="w3_login">
					...
					<input type="hidden" value="Distributer" name="from">
					<select name="proid">
					<option value="">Select Prodict Id</option>
						...
						String selectemo = "select * from shipment where Distributer=0";
                       ...
                       <%}%>
                        ...
                        <input type=submit value="Update" style="background-color: activeborder;color: black;">
					</form></center>
