...
$(document).ready(function() {
	...
	<link rel="stylesheet" href="css/alert.css" type="text/css"></link></head>
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				%> 
					<center><div class="alert" align="center">
			...
			this.innerHTML = '...Sending';
									...
									<div class="registration_form">
										...
										<form action="ManufactureRegister" method="post">
											...
											<div>
												<label>
													<input placeholder="Your Email:" type="email" tabindex="2"
								...
								<div class="registration_left">
									...
									<div class="registration_form">
										<!-- Form -->
										<form action="ManifactureLogin" method="post">
											<div>
												<label>
													<input placeholder="email:" name="email" type="email" tabindex="3"
														required="">
												</label>
											</div>
											<div>
												<label>
													<input placeholder="password" name="pass" type="password" tabindex="4"
														required="">
												</label>
											</div>
											<div>
